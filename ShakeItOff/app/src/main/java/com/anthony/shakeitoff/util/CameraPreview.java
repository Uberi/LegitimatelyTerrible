package com.anthony.shakeitoff.util;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        } catch (IOException e) { Log.d("CameraPreview", "Error setting camera preview: " + e.getMessage()); }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        if (mHolder.getSurface() == null) return; // preview surface doesn't exist
        ...
        } catch (Exception e){ Log.d("CameraPreview", "Error starting camera preview: " + e.getMessage()); }
    }
}
